...
void main() {
  ...
  final animeMatcher = AnimeResponse(
      id: "330357",
      title: "Koori Zokusei Danshi to Cool na Douryou Joshi",
      poster:
          "https://gogocdn.net/cover/koori-zokusei-danshi-to-cool-na-douryou-joshi-1672330793.png",
  ...
  const entityMatcher = AnimeEntity(
    id: "330357",
    title: "Koori Zokusei Danshi to Cool na Douryou Joshi",
    poster:
        "https://gogocdn.net/cover/koori-zokusei-danshi-to-cool-na-douryou-joshi-1672330793.png",
  ...
  const entityMatcherDefault = AnimeEntity(
    id: "330357",
    title: "-",
    poster: "-",
    genre: "-",
  ...
  final animeMatcherNull = AnimeResponse(id: "330357");

  group("From json", () {
    test("Should return correct AnimeResponse", () {
      //arrange

      //act
      final result = AnimeResponse.fromJson(jsonMatcher);

      //assert
      expect(result, animeMatcher);
    });
    ...
    test("Should return null value if field null", () {
      ...
      //act
      final result = AnimeResponse.fromJson(jsonMatcherNull);

      //assert
      expect(result, animeMatcherNull);
  ...
  group("To json", () {
    test("Should return correct json", () {
      ...
      //act
      final result = animeMatcher.toJson();
    ...
    test("Should return correct json if field null", () {
      ...
      //act
      final result = animeMatcherNull.toJson();
  ...
  group("To entity", () {
    test("Should return correct Anime entity", () {
      ...
      //act
      final result = animeMatcher.toEntity();
    ...
    test("Should return default value if field null", () {
      ...
      //act
      final result = animeMatcherNull.toEntity();
